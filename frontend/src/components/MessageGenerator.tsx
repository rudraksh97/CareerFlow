              ...
              <div className='space-y-6'>
                <div className='card p-4 bg-neutral-50'>
                  ...
                  <div className='text-sm text-neutral-600 space-y-1'>
                    <p>
                      <strong>Type:</strong> {formatMessageType(template.message_type)}
                    </p>
                    {template.target_company && (
                      <p>
                        <strong>Target Company:</strong> {template.target_company}
                      </p>
                    )}
                    {template.target_position && (
                      <p>
                        <strong>Target Position:</strong> {template.target_position}
                      </p>
                    )}
                    <p>
              ...
              <div className='space-y-4'>
                ...
                {generatedMessage ? (
                  ...
                  <div className='card p-8 text-center text-neutral-500'>
                    ...
                    <p>
                      Fill in the details and click "Generate Message" to create your personalized
                      referral message.
                    </p>
                  </div>
                )}
