            ...
            <div className="card max-w-2xl p-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 gap-6">
                        <div>
                            <label htmlFor="full_name" className="block text-sm font-medium text-neutral-700 mb-2">Full Name</label>
                        ...
                        <div>
                            <label htmlFor="headline" className="block text-sm font-medium text-neutral-700 mb-2">Headline</label>
                            <div className="relative">
                                <span className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                        ...
                        <div>
                            <label htmlFor="linkedin_url" className="block text-sm font-medium text-neutral-700 mb-2">LinkedIn URL</label>
                            <div className="relative">
                                <span className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
