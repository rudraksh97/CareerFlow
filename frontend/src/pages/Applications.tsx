                      ...
                      >
                        ...
                        <td className="p-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="font-medium text-neutral-900">{application.company_name}</div>
                              <div className="text-sm text-neutral-500">Applied {new Date(application.date_applied).toLocaleDateString()}</div>
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="p-4">
                          <div>
                            <div className="font-medium text-neutral-900 mb-1">{application.job_title}</div>
                            {application.job_url && (
                              <a
                        ...
                        <td className="p-4">
                          {application.resume_filename ? (
                            ...
                            >
                              ...
                              <span className="text-sm truncate max-w-32" title={application.resume_filename}>
                                {application.resume_filename}
                              </span>
                        ...
                        <td className="p-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-neutral-700">{application.email_used}</span>
                          </div>
                        </td>
                        ...
                        <td className="p-4">
                          {application.notes ? (
                            <div className="text-sm text-neutral-700 max-w-48 truncate" title={application.notes}>
                              {application.notes}
                            </div>
                          ) : (
                            <span className="text-sm text-neutral-400">-</span>
