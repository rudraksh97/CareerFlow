...
import { Download, Building, Briefcase, Calendar, FileText, Upload, Plus } from 'lucide-react';
                ...
                <motion.div variants={itemVariants} className="space-y-6">
                    ...
                    {isLoading ? (
                        ...
                        >
                            ...
                            <h3 className="text-xl font-semibold text-neutral-900 mb-2">Failed to load resumes</h3>
                                        ...
                                        <div className="flex-1">
                                            <div className="flex items-start gap-3 mb-4">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <h3 className="font-semibold text-lg text-neutral-900 truncate group-hover:text-blue-600 transition-colors" title={app.resume_filename}>
                                                        {app.resume_filename}
                                                    </h3>
                                                </div>
                                            </div>
