...
export default function CoverLetters() {
  const { data: applications, isLoading, error } = useQuery<ApplicationWithCoverLetter[]>({
    ...
    >
      ...
      <motion.div variants={itemVariants} className="space-y-6">
        ...
        <div className="card p-6">
          ...
          {coverLetterApplications && coverLetterApplications.length === 0 && !isLoading && !error && (
          ...
          {(coverLetterApplications && coverLetterApplications.length > 0) && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-lg bg-neutral-50 border border-neutral-200">
                ...
                <p className="text-sm text-neutral-600">
                  {coverLetterApplications?.length || 0} cover letter{(coverLetterApplications?.length || 0) !== 1 ? 's' : ''} uploaded
                </p>
              </div>
            </div>
          )}
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {Array.from({ length: 8 }).map((_, index) => (
              <div key={index} className="card p-6 animate-pulse">
                ...
                <div className="h-4 bg-neutral-100 rounded w-1/2 mb-6"></div>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-neutral-900 mb-2">Failed to load cover letters</h3>
            <p className="text-neutral-600 mb-6">Please try refreshing the page or contact support if the problem persists.</p>
            <motion.button
                  ...
                  <div className="flex-1">
                    <div className="flex items-start gap-3 mb-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-semibold text-lg text-neutral-900 truncate group-hover:text-blue-600 transition-colors" title={app.cover_letter_filename}>
